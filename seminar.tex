...
\subsubsection{Prayer}
    ...
    Praying over specific names and needs is also a great way to remember people and their needs, which helps build relationships.\footnote{Note to editors: would this better belong in the ``developing relationships'' section?}
...
\subsubsection{Developing Relationships}
    ...
    This means remembering names and other details about those we serve, with the intention of forming long-term relationships.
